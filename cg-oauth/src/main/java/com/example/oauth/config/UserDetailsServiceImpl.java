...
import com.example.oauth.util.UserJwt;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
      ...
      //  String pwd = new BCryptPasswordEncoder().encode("szitheima");
        Result<com.example.user.pojo.User> user=userFeign.findById(username);
       // String pwd = userFeign.findByUsername(username).getData().getPassword();
        //创建User对象
        String permissions = "goods_list,seckill_list,user";
